...
PRÓXIMO PASSO: Convide via painel administrativo`;
  ...
  const openDashboard = () => {
    alert('Funcionalidade de painel administrativo será implementada em breve.');
  };
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={openDashboard} variant="outline" size="sm">
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Para finalizar o cadastro:</strong>
              <ol className="list-decimal list-inside mt-2 space-y-1 text-sm">
                <li>Copie as informações completas acima</li>
                <li>Abra o Painel Administrativo</li>
                <li>Vá em "Users" → "Invite User"</li>
                <li>Cole email: <strong>{pendingUser.email}</strong></li>
                <li>Defina função: <strong>{pendingUser.role === 'admin' ? 'Administrador' : 'Usuário'}</strong></li>
            ...
            <Card>
              <CardContent className="p-4 space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div><strong>Tipo:</strong> {pendingUser.tipo_negocio}</div>
